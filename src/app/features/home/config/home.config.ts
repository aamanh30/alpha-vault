export const howItWorksDetails = {
  ...
  percentage: null,
  isTrending: null,
  content: `Alpha Vault automates your crypto investment for a sustainable growth. Users can simply choose from a list of pre-defined portfolios such as NFTs, Defi, Web 3.0, Metaverse etc. based on their risk appetite and invest through an easy-to-use interface. Invest and let our easy-to-use platform manage your crypto investment automatically. Forget about maintaining several wallets, portfolio tracking, research, and complicated charts, Alpha Vault will analyze those multiple dimensions for you by using our proprietary and advanced AI and ML algorithms to optimze the profit. Alpha Vault is fully decentralized meaning you only copy our strategy and we never touch your funds. The portfolio is accessible only through your device and no one else, preventing any central point of failure. Your keys, your funds!`
};
